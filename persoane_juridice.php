                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                <tr>
                                    <td align="left" valign="middle" style="font-family: Verdana, Geneva, Helvetica, Arial, sans-serif; font-size: 24px; color: #0C4C69; padding:3%; padding-top:40px; padding-bottom:40px;">
                                        Raport lunar persoane pentru conturi pe plata
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                        <table width="94%" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td width="25%" align="left" bgcolor="#2B0057" style="font-family: Verdana, Geneva, Helvetica, Arial, sans-serif; font-size: 12px; color: #EEEEEE; padding:10px; padding-right:0;">
                                                    Client ID
                                                </td>
                                                <td width="25%" align="left" bgcolor="#2B0057" style="font-family: Verdana, Geneva, Helvetica, Arial, sans-serif; font-size: 12px; color: #EEEEEE; padding:10px; padding-right:0;">
                                                    Balanta / debit
                                                ...
                                                <td width="25%" align="right" bgcolor="#2B0057" style="font-family: Verdana, Geneva, Helvetica, Arial, sans-serif; font-size: 12px; color: #EEEEEE; padding:10px;">
                                                    Tarif
                                                </td>
                                            </tr>
                                            <?php
                                            ...
                                            foreach ($report as $user_id => $user):
                                                if($user['sent_sms'] == true): ?>
                                                <tr>
                                                    <td width="25%" align="left" bgcolor="#FFFFFF" style="font-family: Verdana, Geneva, Helvetica, Arial, sans-serif; font-size: 12px; color: #252525; padding:10px; padding-right:0;">
                                                        <?php echo $user_id; ?>
                                                    </td>
                                                    <td width="25%" align="left" bgcolor="#FFFFFF" style="font-family: Verdana, Geneva, Helvetica, Arial, sans-serif; font-size: 12px; color: #252525; padding:10px; padding-right:0;">
                                                    ...
                                                    <td width="25%" align="right" bgcolor="#FFFFFF" style="font-family: Verdana, Geneva, Helvetica, Arial, sans-serif; font-size: 12px; color: #252525; padding:10px;">
                                                        <?php echo $user['tarif']; ?>
                                                    </td>
                                                </tr>
                                                <?php
                                            ...
                                            endforeach; ?>
                                            <tr>
                                                <td width="75%" colspan="3" align="right" bgcolor="#FFFFFF" style="font-family: Verdana, Geneva, Helvetica, Arial, sans-serif; font-size: 12px; color: #252525; padding:10px; padding-left:0;">
                                                    <b>Total conturi pe plata</b>
                                                </td>
                                                <td width="25%" align="right" bgcolor="#FFFFFF" style="font-family: Verdana, Geneva, Helvetica, Arial, sans-serif; font-size: 12px; color: #252525; padding:10px; padding-left:0;">
...
$mail->Body    = $mail_body;
$mail->AltBody = 'Total conturi de plata: ' . $sent_sms;
